"""Build DJIA-30 per-ticker per-day technical features for Phase 2.
...
Output:
    data/djia30/features/year={YYYY}/part.parquet
...
def main() -> int:
    ...
    if not PRICES_PATH.exists():
        print(f"ERROR: missing {PRICES_PATH}; run build_djia30_prices.py "
              f"first.", flush=True)
        return 1
